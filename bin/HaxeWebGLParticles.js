...
GPUParticles2.prototype.particleCount = null;
GPUParticles2.prototype.particleSize = null;
GPUParticles2.prototype.wallFriction = null;
GPUParticles2.prototype.mvMatrix = null;
GPUParticles2.prototype.texWidth = null;
GPUParticles2.prototype.texHeight = null;
...
GPUParticles2.prototype.calculateTexWidthAndHeight = function() {
...
CanvasManager.prototype.onCanvasMouseMove = function(ev) {
	...
	this.lastMouseX = ev.clientX;
	this.lastMouseY = ev.clientY;
	this.system.mvMatrix.reset();
	this.system.mvMatrix.translate(this.translateX,this.translateY,0);
}
...
webgl.textures.RenderTarget2D.prototype.setupFBO = function() {
	...
	if(this.gl.checkFramebufferStatus(this.gl.FRAMEBUFFER) != this.gl.FRAMEBUFFER_COMPLETE) haxe.Log.trace("FLOAT as the color attachment to an FBO",{ fileName : "RenderTarget2D.hx", lineNumber : 26, className : "webgl.textures.RenderTarget2D", methodName : "setupFBO"});
}
...
Main.prototype._gpuParticles2 = null;
...
Main.prototype.onWindowLoaded = function(e) {
	...
	this._gpuParticles2 = new GPUParticles2(this.gl);
	new js.JQuery("#numParticlesInp").val(this._gpuParticles2.particleCount + "");
	new js.JQuery("#particleSizeInp").val(this._gpuParticles2.particleSize + "");
	new js.JQuery("#wallFrictionInp").val(this._gpuParticles2.wallFriction + "");
...
Main.prototype.onUpdateButtonClicked = function(e) {
	var dontTex = new js.JQuery("#dontTexLookupChk")["is"](":checked");
	this._gpuParticles2.particleCount = Std.parseInt(new js.JQuery("#numParticlesInp").val());
	this._gpuParticles2.particleSize = Std.parseInt(new js.JQuery("#particleSizeInp").val());
	this._gpuParticles2.wallFriction = Std.parseFloat(new js.JQuery("#wallFrictionInp").val());
	this._gpuParticles2.reset();
}
Main.prototype.tick = function() {
	utils.RequestAnimationFrame.request($closure(this,"tick"));
	this._gpuParticles2.update();
	this.framerate.inc();
}
